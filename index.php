...
<div class="container">
    ...
    <div class="row mt-3">
        <div class="car-card col-sm-3 border">
            <button style="background: none; border: none" data-bs-toggle="modal" data-bs-target="#exampleModal">
                <img class="mt-1 car-photo" src="assets/Chevrolet-Spark-2013-blue.png" style="width:90%">
                <h3 class="mt-3">Chevrolet Spark</h3>
                <small>Manual, 1l, TPL</small>
                <div class="row mt-5">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-12 text-center mb-4">
                                        ...
                                        <hr>
                                        <img src="assets/Chevrolet-Spark-2013-blue.png"
                                             style="width:60%">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-7 mt-2" id="spec">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>Radio, Audio-CD, MP3, USB, AUX</td>
                                            </tr>
                                            <tr>
